...
$(() => {
  ...
  const $openSquirtModal = $('#openSquirtModal')
  const $squirtModal = $('#squirtModal')
  const $closeSquirtModal = $('#closeSquirtModal')


  const openSquirtModal = (event) => {
    $squirtModal.css('display', 'block')
  }

  const closeSquirtModal = (event) => {
    $squirtModal.css('display', 'none')
  }


  $openSquirtModal.on('click', openSquirtModal)
  $closeSquirtModal.on('click', closeSquirtModal)
